...
namespace PowerLanguage.Strategy
{
    ...
    public class clicktrader : SignalObject
    {
        ...
        // Order objects
        private IOrderMarket m_MarketBuy; // Using market order for testing
        ...
        protected override void Create()
        {
            ...
            // Create a market buy order instead of stop limit for testing
            ...
            Output.WriteLine("*** CLICKTRADER STRATEGY INITIALIZED - VERSION 1.2 ***");
        ...
        protected override void CalcBar()
        {
            ...
            if (StrategyInfo.MarketPosition == 0) // Flat position
            {
                ...
                if (m_ClickPrice > 0)
                {
                    ...
                    Output.WriteLine("Order sent successfully");
